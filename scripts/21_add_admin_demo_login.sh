...
# Replace the file with an updated version that includes "Sign In Demo"
cat > "$FILE" <<'PAGE'
"use client";
...
# Ensure next config exposes the envs to the client
cat > /opt/pwl-os/admin/next.config.js <<'NEXTCFG'
module.exports = {
  env: {
    NEXT_PUBLIC_API_BASE_URL: process.env.API_BASE_URL,
    NEXT_PUBLIC_DEMO_ADMIN_EMAIL: process.env.DEMO_ADMIN_EMAIL,
    NEXT_PUBLIC_DEMO_ADMIN_PASSWORD: process.env.DEMO_ADMIN_PASSWORD
  }
};
NEXTCFG

echo "✅ Admin demo login button added."
